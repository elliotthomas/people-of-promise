...
class Tiles extends Component {
  ...
  render() {
    ...
    return (
        ...
        <a onClick={this.props.clickLink} data-value = '2019-11-03' href= '#introPerson' className = 'calendar-link day-9'>November 3<br />Joshua & Caleb</a>
        ...
        <a onClick={this.props.clickLink} data-value = '2020-02-02' href= '#introPerson' className = 'calendar-link day-23'>February 2<br />Prodigal Father/Son</a>
        ...
        <a onClick={this.props.clickLink} data-value = '2020-03-29' href= '#introPerson' className = 'calendar-link day-31' style = {{fontSize: '16pt'}}>March 29<br />Prisca & Aquila </a>
        ...
        <a onClick={this.props.clickLink} data-value = '2020-04-26' href= '#introPerson' className = 'calendar-link day-35'style = {{fontSize: '16pt'}}>April 26<br />Faithful Servant</a>
