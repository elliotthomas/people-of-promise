    ...
    return (
        <div onClick = {this.goToTiles} className= "outer-div-welcome">
          {/* <h1 className = "big-heading">Welcome to People of Promise</h1> */}
              ...
              <p className = "main-content">Elliot Thomas<br/>Brooke Struck<br/>Ruth Haugstad<br/>Ami Schlampp<br/>Mike Duffy<br/>Connie Priez<br/>Kerry Dressen<br/>Tonsha Belland<br/>Dan Segersin<br/>Brent Kastler<br/>Melony Weathermon<br/>Jill Sonnek<br/>Stephanie Kruger <br/>Kris Paulsen<br/>Ann Pavelka<br/><br/>Pastor Joel Quie</p>
        </div>
    );
  }
}
